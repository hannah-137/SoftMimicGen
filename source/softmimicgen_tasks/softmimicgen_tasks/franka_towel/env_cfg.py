...
from isaaclab.assets import ArticulationCfg, AssetBaseCfg, DeformableCfg, DeformableObjectCfg, RigidObjectCfg
...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    object: RigidObjectCfg | DeformableObjectCfg | DeformableCfg = MISSING
